import { PathFunc, Pen, Unit } from './types.js';
import { DXF_TEMPLATE } from './dxfTemplate.js';
...
class DxfCircle implements DxfEntity {
  ...
  constructor(_recorder: DxfRecorder, x0: number, y0: number, r: number) {
    this.replacers = {
      '@@x0': String(x0),
      '@@y0': String(y0),
      '@@r': String(r),
